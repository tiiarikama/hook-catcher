 ...
 */
async function connect(uri = defaultUri, options = {}) {
    if (client) {
        console.warn("Already connected to the MongoDB database.");
        return client;
    }
    client = new mongodb_1.MongoClient(uri, { ...defaultConfig, ...options });
    try {
...
exports.default = { connect, disconnect, MONGO_COLLECTION_NAME, MONGO_DB_NAME };
